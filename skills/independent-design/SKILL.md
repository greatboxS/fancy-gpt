...
description: Derive a complete design from requirements and constraints without candidate-solution anchoring.
compatibility: fancy-gpt MCP/CLI
---

# independent-design

Use this skill when the requested reasoning mode is **design**. Technical specialization belongs in the request `domains` and `focus`; do not create a new skill for a narrow technology.
...
Required report sections: executive-summary, design, alternatives, risks, validation-plan.

Quality gates:
- Candidate-solution artifacts are excluded by data flow.
- A complete reusable design deliverable is required.
