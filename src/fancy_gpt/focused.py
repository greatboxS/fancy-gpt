...
from .project_models import ConversationStrategy, RelevantProjectContext
    ...
    def run(self, question: FocusedQuestion, provider: AutomaticModelProvider) -> FocusedAnswer:
        ...
        try:
            ...
            if response.conversation_binding:
                answer = answer.model_copy(update={"conversation_binding": response.conversation_binding})
