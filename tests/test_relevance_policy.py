...
def test_focused_answer_propagates_conversation_binding() -> None:
    ...
    assert answer.conversation_binding and answer.conversation_binding.startswith("fake://conversation/")
    assert ("conversation", "resume", "project:demo:role:implementer") in driver.events
